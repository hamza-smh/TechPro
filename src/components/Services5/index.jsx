        ...
        <div className="row">
          ...
          <div className="col-lg-5 offset-lg-1 valign">
            <div className="cont">
              ...
              <p> Techprologist has been focusing on project management & implementation through cooperation.</p>
              <p>In total, Techprologist has created more than 2000 projects related to constructional designing and landscaping worldwide.</p>
            </div>
          </div>
        </div>
      </div>
