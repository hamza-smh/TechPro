    ...
    return (
      <Html lang="en">
        <Head>
          ...
          <meta
            name="keywords"
            content="HTML5 Template Techprologist onepage themeforest"
          />
          <meta
            name="description"
            content="Techprologist - Onepage Multi-Purpose HTML5 Template"
          />
          <meta name="author" content="" />
          <link rel="shortcut icon" href="/img/Techprologist Icon.ico" />
          {/* Google Fonts */}
          <link
